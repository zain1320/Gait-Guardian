...
class GaitAnalyzerApp:
    ...
    def setup_ui(self):
        ...
        header = ttk.Label(self.root, text="Real-time Gait Analysis System", font=("Arial", 24, "bold"))
        header.grid(row=0, column=0, columnspan=2, pady=10)
        
        # Arduino Connection Frame
        self.port_frame = ttk.LabelFrame(self.root, text="Arduino Connection")
        self.port_frame.grid(row=1, column=0, sticky="nsew", padx=10, pady=10)
        
        ttk.Label(self.port_frame, text="Serial Port:").grid(row=0, column=0, padx=5, pady=5, sticky="e")
        self.port_var = tk.StringVar()
        self.port_combo = ttk.Combobox(self.port_frame, textvariable=self.port_var, width=15)
        ...
        ttk.Label(self.port_frame, text="Status:").grid(row=1, column=0, padx=5, pady=5, sticky="e")
        self.status_var = tk.StringVar(value="Disconnected")
        ttk.Label(self.port_frame, textvariable=self.status_var).grid(row=1, column=1, padx=5, pady=5, sticky="w")
        
        ttk.Label(self.port_frame, text="Data points:").grid(row=1, column=2, padx=5, pady=5, sticky="e")
        self.data_count_var = tk.StringVar(value="0")
        ttk.Label(self.port_frame, textvariable=self.data_count_var).grid(row=1, column=3, padx=5, pady=5, sticky="w")
        
        # Classification Results Frame
        self.results_frame = ttk.LabelFrame(self.root, text="Classification Results")
        self.results_frame.grid(row=1, column=1, sticky="nsew", padx=10, pady=10)
        ...
        self.confidence_label.grid(row=1, column=0, padx=10, pady=10)
        
        # Probability Bars Frame (inside results frame)
        self.prob_frame = ttk.Frame(self.results_frame)
        self.prob_frame.grid(row=2, column=0, padx=10, pady=10, sticky="nsew")
        ...
        for i, gait_type in enumerate(self.gait_types):
            ttk.Label(self.prob_frame, text=gait_type.capitalize()).grid(row=i, column=0, padx=5, pady=5, sticky="w")
            progress = ttk.Progressbar(self.prob_frame, length=300, mode='determinate')
